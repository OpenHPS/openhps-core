...
export class EulerOrientation {
    ...
    public static fromVector(vector: number[], unit: AngleUnit = AngleUnit.RADIANS): EulerOrientation {
        return new EulerOrientation(vector[0], vector[1], vector[2], unit);
    }
