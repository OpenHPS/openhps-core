import 'mocha';
import { DataFrameService, Model, DataFrame, ModelBuilder, LoggingSinkNode, DataObject } from '../../../src';
...
describe('data frame service', () => {
    describe('output layer', () => {
        ...
        before(async () => {
            model = await ModelBuilder.create().from().to(new LoggingSinkNode()).build();
