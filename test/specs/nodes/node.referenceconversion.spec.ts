...
describe('node', () => {
    describe('referenceconversion', () => {
        it('should convert from and to the reference space', (done) => {
            ...
            const myReferenceSpace = new ReferenceSpace(globalReferenceSpace).translation(10, 10, 0);
            ...
            ModelBuilder.create()
                ...
                .addShape(
                    GraphBuilder.create()
                        ...
                        .via(
                            new ReferenceSpaceConversionNode(myReferenceSpace, {
                                inverse: true,
                            }),
                        )
