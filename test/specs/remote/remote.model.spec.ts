...
describe('RemoteService', () => {
    describe('service', () => {
        let server: Model;
        let client: Model;
        const server_sink: CallbackSinkNode<any> = new CallbackSinkNode();
        const client_sink: CallbackSinkNode<any> = new CallbackSinkNode();
        ...
        before(async () => {
            ...
            client = await ModelBuilder.create()
                ...
                .addService(
                    new KeyValueDataService('test123'),
