    ...
    describe('laoudias2013', function() {
        ...
        before(function (done) {
            ...
            ModelBuilder.create()
                ...
                .build().then((model: Model<any, any>) => {
        ...
        describe('online stage knn with k=5', () => {
            ...
            before((done) => {
                ModelBuilder.create()
                    ...
                    .from(new CSVDataSource("test/data/laoudias2013/Test data/indoor-test-nexus.txt", (row: any) => {
                        ...
                        evaluationObject.position = new Absolute2DPosition(parseFloat(row['# X']), parseFloat(row['  Y']));
            ...
            it('should have an average error of less than 5 meters', (done) => {
                ...
                callbackNode.callback = (data: EvaluationDataFrame) => {
                    let calculatedLocation: Absolute2DPosition = data.getObjectByUID("phone").position as Absolute2DPosition;
                    // Accurate control location
                    const expectedLocation: Absolute2DPosition = data.evaluationObjects.get("phone").position as Absolute2DPosition;
