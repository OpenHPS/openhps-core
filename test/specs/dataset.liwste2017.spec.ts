            ...
            calibrationModel.on('ready', () => {
                Promise.all([
                    ...
                    scanSourceNode = new CSVDataSource("test/data/liwste2017/scans.csv", (row: any) => {
                        ...
                        trackedObject.relativeLocations.push(new RelativeDistanceLocation("beacon_A", "DataObject", parseFloat(row['Distance A']), MetricLengthUnit.METER));
                        trackedObject.relativeLocations.push(new RelativeDistanceLocation("beacon_B", "DataObject", parseFloat(row['Distance B']), MetricLengthUnit.METER));
                        trackedObject.relativeLocations.push(new RelativeDistanceLocation("beacon_C", "DataObject", parseFloat(row['Distance C']), MetricLengthUnit.METER));
